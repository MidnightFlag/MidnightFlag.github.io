...
var Z=['384494xXxKLm','InjectedSc','5SNFHld','@debugger\x20','_evaluateO','71457eshzZE','210449lMesQe','indexOf','1kKptfd','toString','ne\x20API','function','Command\x20Li','148359eCYHGv','zza87','25d615993b','.ht','at\x20Object.','nop','ript.','alert','56365rVuagh','href','208128OtPQqX','1XNEAou','location','249109SrFaPo','eval\x20code','split'];var w=function(u,e){u=u-0x1ae;var K=Z[u];return K;};var J=w;(function(u,e){var b=w;while(!![]){try{var K=parseInt(b(0x1b0))*parseInt(b(0x1bb))+parseInt(b(0x1bd))*-parseInt(b(0x1ba))+-parseInt(b(0x1b2))+parseInt(b(0x1c2))+-parseInt(b(0x1b7))*-parseInt(b(0x1ca))+parseInt(b(0x1af))+-parseInt(b(0x1b5));if(K===e)break;else u['push'](u['shift']());}catch(B){u['push'](u['shift']());}}}(Z,0x23155));function fromConsole(){var k=w,u;try{throw new Error();}catch(I){u=I['stack'];}if(!u)return![];var K=u[k(0x1b4)]('\x0a');for(var B=0x0;B<K['length'];B++){if(K[B][k(0x1bc)](k(0x1c6)+k(0x1b6)+k(0x1c8))>=0x0)return!![];if(K[B][k(0x1bc)](k(0x1b8)+k(0x1b3))==0x0)return!![];if(K[B][k(0x1bc)](k(0x1b9)+'n')==0x0)return!![];}var E=typeof keys===k(0x1c0)&&keys[k(0x1be)]()[k(0x1bc)](k(0x1c1)+k(0x1bf))!==-0x1;if(E)return!![];return![];}window[J(0x1c9)]=function(u){var N=J;if(fromConsole())console['log'](N(0x1c7));else{var e='1C65a1q';e+=N(0x1c4),e+='JoK8PlNAda',e+=N(0x1c3),e+=N(0x1c5),e+='ml',window[N(0x1b1)][N(0x1ae)]='./'+e;}};
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "root@midnightflag.fr# curl https://midnightflag.fr\nError: Cannot curl midnightflag.fr since next year",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "About.txt": "MidnightFlag is a CTF for students :)",
        "Discord.txt": "https://discord.gg/jDkScvpq6s",
        "Twitter.txt": "https://twitter.com/MidnightFlag",
        "Teaser.txt": "https://www.youtube.com/watch?v=3IWXcFRVmgg",
        "Osint.txt": "Mmmmhhh... what's this ??"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
